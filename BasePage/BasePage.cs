...
namespace SpecFlowProject2.BasePage
{
    public abstract class BasePage
    {
        ...
        public bool IsElementDisplayed(string elementName)
        {
            try
            {
                return ReturnElement(elementName).Displayed;
            }
        ...
        public bool isCookieBUttonVisible(IWebDriver driver)
        {
            try
            {
                IWebElement cookieButton = driver.FindElement(By.Id("//*[@data-cky-tag='accept-button']"));
                return cookieButton.Displayed && cookieButton.Enabled;
